...
Demonstrates encapsulation by building information into sub sections and then building on top of those 

Would it have been easier to implement a solution to this problem using a different coding style? Why or why not?
No, not that i'm aware of, because everything seems to be simpler in Python for better or for worse 

How in particular did Object Oriented Programming assist in the solving of this problem?
Orientates the data around what is needed? 
